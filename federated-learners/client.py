...
from dataset_manager import SubLoader
...
def load_data():
    ...
    trainset = SubLoader(".", include_list=["plane"], train=True, download=True, transform=transform)
    testset = SubLoader(".", include_list=["plane"], train=False, download=True, transform=transform)
